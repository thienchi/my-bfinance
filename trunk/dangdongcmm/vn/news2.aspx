<%@ Page Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="news2.aspx.cs" Inherits="dangdongcmm.news2" %>
                    ...
                    <ASP:REPEATER ID="rptListfollow" runat="server" >
                        <ITEMTEMPLATE>
                            <div class="article" style="background:url(../images/divide1.png) no-repeat bottom left; padding-bottom:10px;">
                                <%--<div class="inlist"><a href="/<%#Eval("eUrl2") %>?pag=<%=PageIndex %>"><%#Eval("Name")%></a> <%#Eval("eIconex")%></div>--%>
                    ...
                    <ASP:REPEATER ID="rptListByCategory" runat="server" OnItemDataBound="rptListByCategory_ItemDataBound">
                        <ITEMTEMPLATE>
                            ...
                            <div class="articleinmenu">
                                <div class="first"><a href="/<%#Eval("eUrl2").ToString().Replace(".aspx","") + ".aspx" %>"><%#Eval("Name") %></a></div>
