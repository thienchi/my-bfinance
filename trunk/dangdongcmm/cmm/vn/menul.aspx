<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="menul.aspx.cs" Inherits="dangdongcmm.cmm.menul" %>
...
<ASP:CONTENT ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ASP:UPDATEPANEL ID="UpdatePanel1" runat="server">
        ...
        <ASP:PANEL id="pnlList" runat="server" width="100%">
                    ...
                    <ASP:PANEL ID="panelSearch" runat="server" DefaultButton="cmdSearch">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td><ASP:DROPDOWNLIST ID="ddlCid" runat="server" onchange="ddlGotopage(this, 'menul.aspx');"></ASP:DROPDOWNLIST></td>
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:TEMPLATEFIELD headertext="Menu con" sortexpression="Depth" itemstyle-cssclass="colpis">
                        <ITEMTEMPLATE>
                            <a href='menul.aspx?cid=<%#Eval("Cid") %>&pid=<%#Eval("Id") %>'><%#Eval("Pis").ToString() == "0" ? "" : ("Menu con " + (Convert.ToInt32(Eval("Depth")) + 1)) + " (" + Eval("ePis") + ")"%></a>
                        </ITEMTEMPLATE>
                    </ASP:TEMPLATEFIELD>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('menuu.aspx?cid=<%#Eval("Cid") %>&pid=<%#Eval("Pid") %>&iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
        ...
        <ASP:PANEL id="pnlCopy" runat="server" Visible="false" CssClass="tformin tformincom">
            ...
            <div class="rowhor">
                <div class="boxctrlc">Loại menu</div>
                <div class="boxctrlc" style="margin-left:20px;">Menu cha</div>
            </div>
            <div class="rowhor">
            ...
            <div class="rowhor">
                <fieldset>
                    ...
                    <div>
                        <ASP:CHECKBOX ID="chkCopyoption_getchild" runat="server" Text="Sao chép đồng thời tất cả menu con?" />
                    </div>    
                </fieldset>
            </div>
        </ASP:PANEL>
        ...
        <ASP:PANEL id="pnlMove" runat="server" Visible="false" CssClass="tformin tformincom">
            ...
            <div class="rowhor">
                <fieldset>
                    ...
                    <div>
                        <ASP:CHECKBOX ID="chkMoveoption_getchild" runat="server" Checked="true" Text="Di chuyển đồng thời tất cả menu con?" />
                    </div>    
                </fieldset>
            </div>
        </ASP:PANEL>
