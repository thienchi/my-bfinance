...
{
    public partial class usergroupl : BasePage
    {
        ...
        private string Generate_Parentpath(int pid)
        {
            ...
            if (list_parent != null)
            {
                for (int i = 0; i < list_parent.Count; i++)
                {
                    ...
                    vlreturn += " >> <a href='usergroupl.aspx?pid=" + info.Id + "'>" + info.Name + "</a>";
                }
            }
            return vlreturn;
        }
        private void Init_State()
        {
            ...
            cmdAdd.Attributes.Add("onclick", "CC_gotoUrl('usergroupu.aspx?pid=" + pid + "')");
        }
