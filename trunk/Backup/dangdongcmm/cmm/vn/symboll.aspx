<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="symboll.aspx.cs" Inherits="dangdongcmm.cmm.symboll" %>
        ...
        <ASP:PANEL id="pnlList" runat="server" width="100%">
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:BOUNDFIELD datafield="eFilepreviewcmm" headertext="Biểu tượng" itemstyle-cssclass="colinfo2" HtmlEncode="false"></ASP:BOUNDFIELD>
                    <ASP:BOUNDFIELD datafield="Note" headertext="Ghi chú" sortexpression="Note" itemstyle-cssclass="colinfo3"></ASP:BOUNDFIELD>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('symbolu.aspx?iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
