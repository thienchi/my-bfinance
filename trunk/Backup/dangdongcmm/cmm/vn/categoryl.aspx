<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="categoryl.aspx.cs" Inherits="dangdongcmm.cmm.categoryl" %>
                    ...
                    <ASP:PANEL ID="panelSearch" runat="server" DefaultButton="cmdSearch">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td><ASP:DROPDOWNLIST ID="ddlCid" runat="server" onchange="ddlGotopage(this, 'categoryl.aspx');"></ASP:DROPDOWNLIST></td>
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:TEMPLATEFIELD headertext="Danh mục con" sortexpression="Depth" itemstyle-cssclass="colpis">
                        <ITEMTEMPLATE>
                            <a href='categoryl.aspx?cid=<%#Eval("Cid") %>&pid=<%#Eval("Id") %>'><%#Eval("Pis").ToString() == "0" ? "" : ("Danh mục con " + (Convert.ToInt32(Eval("Depth")) + 1)) + " (" + Eval("ePis") + ")"%></a>
                        </ITEMTEMPLATE>
                    </ASP:TEMPLATEFIELD>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('categoryu.aspx?cid=<%#Eval("Cid") %>&pag=<%=PageIndex %>&pid=<%#Eval("Pid") %>&iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
