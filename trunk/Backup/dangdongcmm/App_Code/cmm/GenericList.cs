...
namespace dangdongcmm.cmm
{
    public class GenericList<I>
    {
        ...
        public GenericList(int pageindex, int pagesize, string sortexp, SortDirection sortdir)
        {
            //
            // TODO: Add constructor logic here
            //
        ...
        public GenericList(ListOptions options)
        {
            if (options != null)
            {
                ...
                this.SortDir = options.SortDir == "Ascending" ? SortDirection.Ascending : SortDirection.Descending;
            }
        }
