<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucpager.ascx.cs" Inherits="dangdongcmm.ucpager" %>
...
<ASP:PANEL ID="pnlList" runat="server" >
    ...
    <table cellspacing="0" cellpadding="5" border="0">
        <tr>
            ...
            <td>
                <ASP:LINKBUTTON ID="cmdPrev" runat="server" Text="Trang trước" OnClick="cmdPrev_Click"></ASP:LINKBUTTON>
            ...
            <td>
                ...
                <ASP:LINKBUTTON ID="cmdNext" runat="server" Text="Trang kế" OnClick="cmdNext_Click"></ASP:LINKBUTTON>
            </td>
        </tr>
    </table>
