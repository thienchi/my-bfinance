                    ...
                    <ASP:REPEATER ID="rptInfo" runat="server">
                        <ITEMTEMPLATE>
                            ...
                            <div class="article contentframe">
                                ...
                                <div class="sharebar">
                                    <div class="g">
                                        <div class="g-plus" data-action="share" data-annotation="bubble" data-href="http://bfinance.vn/vn/<%#Eval("eUrl")%>"></div>
                                        <script type="text/javascript">
                                           window.___gcfg = {        
                                            lang: 'en-US'      
                                           };
                                    ...
                                    <script type="text/javascript" src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="http://bfinance.vn/vn/<%#Eval("eUrl")%>" layout="button_count" action="like" />
                                    
                                </div>           
                                <div class="desc"><%#Eval("eFilepreview")%> <%#Eval("Description")%></div>
                                <div align="right"><b><i><%#Eval("Author")%></i></b></div>
                                <div class="note"><%#CFunctions.IsNullOrEmpty(Eval("Tag").ToString()) ? "" : ("<b>Tag</b>: " + Eval("eTag"))%></div>
                            </div>
                            <br />&nbsp;
                    ...
                    <ASP:REPEATER ID="rptListByCategory" runat="server" OnItemDataBound="rptListByCategory_ItemDataBound">
                        <ITEMTEMPLATE>
                            ...
                            <div class="articleinmenu">
                                <div class="first"><a href="<%#Eval("eUrl") %>"><%#Eval("Name") %></a></div>
