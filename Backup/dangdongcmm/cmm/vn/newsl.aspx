<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="newsl.aspx.cs" Inherits="dangdongcmm.cmm.newsl" %>
                    ...
                    <ASP:PANEL ID="panelSearch" runat="server" DefaultButton="cmdSearch">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td><ASP:DROPDOWNLIST ID="ddlCid" runat="server" onchange="ddlGotopage(this, 'newsl.aspx');"></ASP:DROPDOWNLIST></td>
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('newsu.aspx?cid=<%#Eval("Cid") %>&pag=<%=PageIndex %>&iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
