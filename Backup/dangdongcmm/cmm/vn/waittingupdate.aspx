<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="waittingupdate.aspx.cs" Inherits="dangdongcmm.cmm.waittingupdate" %>
        ...
        <ASP:PANEL id="pnlList" runat="server" width="100%">
            <div class="dformoutcommand">
                ...
                <div class="colsetting">
                    <ASP:BUTTON ID="cmdAccept" runat="server" OnClientClick="javascript:return doSubmitSel();" OnClick="cmdAccept_Click" Text="Chấp nhận" CssClass="buttoncmd" />&nbsp;
                    -- hoặc --
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id,Belongto" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colinfo2">
                        <ITEMTEMPLATE>
                            <ASP:LINKBUTTON ID="lnkAccept" runat="server" CssClass="command" Text="Chấp nhận" CommandName="Update" CommandArgument='<%#Eval("Belongto") %>' CausesValidation="false"></ASP:LINKBUTTON>
                            &nbsp;|&nbsp;
