<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="librariesl.aspx.cs" Inherits="dangdongcmm.cmm.librariesl" %>
        ...
        <ASP:PANEL id="pnlList" runat="server" width="100%">
                    ...
                    <ASP:PANEL ID="panelSearch" runat="server" DefaultButton="cmdSearch">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td><ASP:DROPDOWNLIST ID="ddlCid" runat="server" onchange="ddlGotopage(this, 'librariesl.aspx');"></ASP:DROPDOWNLIST></td>
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:TEMPLATEFIELD headertext="Phản hồi" itemstyle-cssclass="colstatus" sortexpression="Allowcomment">
                        <ITEMTEMPLATE>
                            <a href='commentl.aspx?blto=18&cid=<%#Eval("Cid") %>&pid=<%#Eval("Id") %>'><%#Eval("Allowcomment").ToString() == "0" ? "" : ("Phản hồi (" + (int.Parse(Eval("Allowcomment").ToString()) - 1) + ")")%></a>
                        </ITEMTEMPLATE>
                    </ASP:TEMPLATEFIELD>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('librariesu.aspx?cid=<%#Eval("Cid") %>&pag=<%=PageIndex %>&iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
        ...
        <ASP:PANEL id="pnlCopy" runat="server" Visible="false" CssClass="tformin tformincom">
            ...
            <div class="rowhor">
                <fieldset>
                    ...
                    <div>
                        <ASP:CHECKBOX ID="chkCopyoption_getchild" runat="server" Text="Sao chép đồng thời tất cả phản hồi?" />
                    </div>    
                </fieldset>
            </div>
        </ASP:PANEL>
        ...
        <ASP:PANEL id="pnlMove" runat="server" Visible="false" CssClass="tformin tformincom">
            ...
            <div class="rowhor">
                <fieldset>
                    ...
                    <div>
                        <ASP:CHECKBOX ID="chkMoveoption_getchild" runat="server" Checked="true" Text="Di chuyển đồng thời tất cả phản hồi?" />
                    </div>    
                </fieldset>
            </div>
        </ASP:PANEL>
