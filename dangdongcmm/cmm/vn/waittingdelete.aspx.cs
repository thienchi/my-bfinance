...
{
    public partial class waittingdelete : BasePage
    {
        ...
        private List<GeneralInfo> Load_List()
        {
            ...
            foreach (CategorytypeofInfo infotypeof in listtypeof)
            {
                ...
                List<GeneralInfo> listin = (new CGeneral(CCommon.LANG, tablename)).Waitting_Getlist((int)CConstants.State.Status.Waitdelete, infotypeof.Id, infotypeof.Name);
        ...
        private List<GeneralInfo> Search()
        {
            ...
            foreach (CategorytypeofInfo infotypeof in listtypeof)
            {
                ...
                List<GeneralInfo> listin = (new CGeneral(CCommon.LANG, tablename)).Waitting_Search(keywords, (int)CConstants.State.Status.Waitdelete, infotypeof.Id, infotypeof.Name);
                if (listin == null) continue;
        ...
        {
            string page = CFunctions.Get_Definecatrelate(belongto, "page");
