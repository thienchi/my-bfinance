<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="bannerl.aspx.cs" Inherits="dangdongcmm.cmm.bannerl" %>
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:TEMPLATEFIELD headertext="Tên/ Tiêu đề" sortexpression="Name">
                        <ITEMTEMPLATE>
                            <ASP:LINKBUTTON ID="cmdSetupattribute" runat="server" CommandName="Setupattribute" CommandArgument='<%# Eval("Id")%>' Text='<%#Eval("Name") %>' CausesValidation="false"></ASP:LINKBUTTON>
                        </ITEMTEMPLATE>
                    </ASP:TEMPLATEFIELD>
                    <ASP:BOUNDFIELD datafield="Code" headertext="Mã" itemstyle-cssclass="colinfo3" HtmlEncode="false"></ASP:BOUNDFIELD>
                    <ASP:BOUNDFIELD datafield="Album" headertext="Hình ảnh" itemstyle-cssclass="colinfo3" HtmlEncode="false"></ASP:BOUNDFIELD>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('banneru.aspx?pag=<%=PageIndex %>&iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
