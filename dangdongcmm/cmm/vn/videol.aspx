<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="videol.aspx.cs" Inherits="dangdongcmm.cmm.videol" %>
        ...
        <ASP:PANEL id="pnlList" runat="server" width="100%">
                    ...
                    <ASP:PANEL ID="panelSearch" runat="server" DefaultButton="cmdSearch">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td><ASP:DROPDOWNLIST ID="ddlCid" runat="server" onchange="ddlGotopage(this, 'videol.aspx');"></ASP:DROPDOWNLIST></td>
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:TEMPLATEFIELD headertext="Tiêu đề" sortexpression="Name">
                        <ITEMTEMPLATE>
                    ...
                    <ASP:TEMPLATEFIELD headertext="Phản hồi" itemstyle-cssclass="colstatus">
                        <ITEMTEMPLATE>
                            <a href='commentl.aspx?blto=12&cid=<%#Eval("Cid") %>&pid=<%#Eval("Id") %>'><%#Eval("Allowcomment").ToString() == "0" ? "" : ("Phản hồi (" + (int.Parse(Eval("Allowcomment").ToString()) - 1) + ")")%></a>
                        </ITEMTEMPLATE>
                    </ASP:TEMPLATEFIELD>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('videou.aspx?cid=<%#Eval("Cid") %>&pag=<%=PageIndex %>&iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
