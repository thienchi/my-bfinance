<%@ PAGE Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="menutypeofl.aspx.cs" Inherits="dangdongcmm.cmm.menutypeofl" %>
        ...
        <ASP:PANEL id="pnlList" runat="server" width="100%">
            ...
            <ASP:GRIDVIEW ID="grdView" runat="server" DataKeyNames="Id" CssClass="lgridview" 
                ...
                <COLUMNS>
                    ...
                    <ASP:BOUNDFIELD datafield="Path" headertext="Đường dẫn tập tin" sortexpression="Path" ItemStyle-CssClass="colinfo2"></ASP:BOUNDFIELD>
                    <ASP:TEMPLATEFIELD headertext="Details" itemstyle-cssclass="colstatus">
                        <ITEMTEMPLATE>
                            <a href='menul.aspx?cid=<%#Eval("Id") %>'>Menu con</a>
                        </ITEMTEMPLATE>
                    </ASP:TEMPLATEFIELD>
                    ...
                    <ASP:TEMPLATEFIELD itemstyle-cssclass="colaction">
                        <ITEMTEMPLATE>
                            <a class="command" href="javascript:CC_gotoUrl('menutypeofu.aspx?iid=<%#Eval("Id") %>');">Sửa</a>
                            &nbsp;|&nbsp;
