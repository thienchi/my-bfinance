<%@ Page Language="C#" MasterPageFile="MasterDefault.Master" AutoEventWireup="true" CodeBehind="librariesu.aspx.cs" Inherits="dangdongcmm.cmm.librariesu" %>
...
<%@ REGISTER TagPrefix="UC" TagName="Relatedlibraries" Src="usercontrol/ucrelatedlibraries.ascx" %>
...
<ASP:CONTENT ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ASP:UPDATEPANEL ID="UpdatePanel1" runat="server">
        ...
        <div class="panes">
            ...
            <div class="tformin tformincom">
                <UC:RELATEDLIBRARIES ID="Relatedlibraries" runat="server" />
            </div>
